...
\begin{abstract}
  ...
  Global climate warming is a phenomenon related to nature. 
  ...
  and the global land average temperature is higher than the global average temperature, 
  the global land average temperature is 0.6 degrees higher than the global average temperature; 
  ...
  We think there are 3 measures to curb global warming. 
  The first is to control population growth. 
  ...
  We need to slow down activities and lessen the release level of CO2.
  Improve utilization technology is a very good way to relieve global warming.
  \keywords{Autoregressive integrated moving average\quad  Long short term memory algorithm\\ Grey relative analysis}
